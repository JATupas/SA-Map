...
togglePoi.addEventListener("change", () => {
  if (togglePoi.checked) {
    degminsecFields.style.display = "none"; // Hide DMS fields
    poiFields.style.display = "block";
    decimalFields.style.display = "none"; // Show decimal degrees fields
  }
});
