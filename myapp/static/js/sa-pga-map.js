...
$(document).ready(function() {
    ...
    document.getElementById('check-data').addEventListener('click', function() {
        ...
        document.getElementById('lat-dms').querySelector('#lat-degrees').textContent = latDegrees;
        document.getElementById('lat-dms').querySelector('#lat-minutes').textContent = latMinutes;
        document.getElementById('lat-dms').querySelector('#lat-seconds').textContent = latSeconds;

        document.getElementById('lon-dms').querySelector('#lon-degrees').textContent = lonDegrees;
        document.getElementById('lon-dms').querySelector('#lon-minutes').textContent = lonMinutes;
        document.getElementById('lon-dms').querySelector('#lon-seconds').textContent = lonSeconds;
